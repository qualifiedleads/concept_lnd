<?PHP
	...
	if( isset( $_POST["name"]) )
	{
		...
		$bodyhtml .= "This V.I.P. filled in his/her details on page: " . htmlspecialchars($referer) . "<BR><BR>";
		...
		$subject = "Yalla, a VIP wants information!";
		...
		mail($to, $subject, $bodyhtml, $headers);
		// Send email 3
		$to = "concept4telaviv@yahoo.co.uk";
        mail($to, $subject, $bodyhtml, $headers);
	}
