...
בזכות התוכנית ליזמים של קונספט, הצלחתי לקבל עבודות ופרוייקטים גדולים<span style="color:#66cc33;">&nbsp;</span><span style="color:#66cc33;"> </span><br><span style="color:#0099ff;">מירב גרוסמן</span></p>
                ...
                <div class="testimonials-row">
                    <div class="testimonial">
                        <div class="tinr">
                            <p>
							<ul>
								<li>תהליך העיצוב מהרעיון לביצוע בפועל</li>
								<li>ארכיטקטורת פנים בבתים ודירות פרטיות</li>
								<li>עיצוב חללים מסחריים וחלונות ראווה</li>
								<li>עיצוב פונקציונאלי לדירות קטנות</li>
								<li>הום סטיילינג - הלבשת החלל ודקורציה לאחר שלב התכנון</li>
								<li>קריאת תוכניות, תוכניות עבודה, מידות ופריסת קירות</li>
								<li>תכנון חללים רטובים- חדרי אמבטיה, שירותים ומטבחים</li>
								<li>תורת הבנייה - יסודות, שלד, קירות, פתחים, ציפויים, חיפויים, איטום ועוד</li>
							</ul>
							</p>
                        </div>
                    </div>
                    <div class="testimonial">
                        <div class="tinr">
							...
							<ul>
								...
								<li>כלים לפיתוח חשיבה יצירתית, בחירת צבע וחומר</li>
								<li>סיורי שטח מקצועיים- עבודה עם ספקים וקבלנים</li>
								<li>בנייה וניהול מותג אישי בתחום העיצוב</li>
							</ul>
							</p>
                        </div>
                    </div>
        ...
        <div class="plogos parallax parallax-2" style="text-align:center">
            <div class="container">
                <?php if($detect->isMobile() || $detect->isTablet()):?>
